...
Digitalize street art discovery.
...
**Project Organization:** :  Project is written in Swift using the SwiftUI framework.

___

# INSTALLATION & USAGE

Will update this section when project is done.

___

# ACKNOWLEDGEMENTS

Licensed under the cc0 licence : https://creativecommons.org/publicdomain/zero/1.0/
Artworks & artists data from https://streetartcities.com/
